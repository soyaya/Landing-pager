...
>
  ...
  extra={<a href="#" onClick={() => handleLinkClick('Laborum officia officia do consectetur cupidatat voluptate excepteur qui nisi consectetur culpa dolor.')}>More</a>}
  style={{ width: '100%' }}
>
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    <span style={{ fontSize: '24px', fontSize:'50px' }}><FileAddTwoTone /></span>
  ...
  extra={<a href="#" onClick={() => handleLinkClick('Et deserunt sit eiusmod laborum eiusmod.')}>More</a>}
  style={{ width: '100%' }}
>
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    <span style={{ fontSize: '24px', fontSize:'50px' }}><HighlightTwoTone /></span>
  ...
  extra={<a href="#" onClick={() => handleLinkClick('Adipisicing ea reprehenderit qui officia mollit laboris ea voluptate labore nisi ullamco magna amet.')}>More</a>}
  style={{ width: '100%' }}
>
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    <span style={{ fontSize: '24px', fontSize:'50px' }}><SnippetsTwoTone /></span>
